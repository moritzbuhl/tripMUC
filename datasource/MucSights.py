...
links = []
zipcodes = []
response = get('https://www.muenchen.de/sehenswuerdigkeiten/sehenswerte-plaetze.html', headers = basicHeaders)
...
test_df.to_csv('mucsights.csv')
test_df.to_json('mucsights.json')
print(test_df.info())